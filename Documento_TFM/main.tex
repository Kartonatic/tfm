...
\def\sf{\sffamily}
\def\tt{\ttfamily}
\def\mdata{\raisebox{-.15ex}{\includegraphics[width=10.1ex]{Imagenes/mdata.png}}}
\def\vzconnect{\raisebox{-.15ex}{\includegraphics[width=15.1ex]{Imagenes/VZ.png}}}
...
\includepdf{Autorizaciones/autorizacion.pdf}
\includepdf{Autorizaciones/originalidad.pdf}
...
\input{ArquitecturaPropuesta.tex}
