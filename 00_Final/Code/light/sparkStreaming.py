    ...
    def process(time, rdd):
        ...
        try:
            ...
            if (not rdd.isEmpty()):
                ...
                dataToSend.select(to_json(struct([dataToSend[x] for x in dataToSend.columns])).alias("value")).write.format("kafka").option("kafka.bootstrap.servers", "kafka1:9092").option("topic", topicOut).save()
